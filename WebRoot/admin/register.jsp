...
<form method="post" action="RegisterServlet" autocomplete="off" id = "form">
		<table width="100%" height="100%">
			...
			<tr align="center" class="tr2">
				...
				<td>
					...
					bgcolor="F0FFF0" cellspacing="20"; >
						<caption class="tr5">
							<center>
								<pre>Administrator Register</pre> 
							</center>
						</caption>
						...
						<tr>
							<td><div id="submit_register">
									<center>
										<input type="submit" value="register" class="submit_register" size="4">
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			...
			<tr height="10%" class="tr3">
				<td><center>
						<pre>在 线 学 习 平 台 管 理 员 注 册 界 面</pre>
					</center></td>
			</tr>
