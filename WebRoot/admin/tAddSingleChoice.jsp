...
<form action="TeacherAddSingleChoiceServlet" method="post" id ="form" >
		...
		<table align="center" width="40%">
			...
			<tr class="tr">
				...
				<td><input type="text" size="64" class="input" name="question"></td>
			</tr>
			<tr class="tr">
				<td align="center">第一个选项</td>
				<td><input type="text" size="64" class="input" name="one"></td>
			</tr>
			<tr class="tr">
				<td align="center">第二个选项</td>
				<td><input type="text" size="64" class="input" name="two"></td>
			</tr>
		    <tr class="tr">
				<td align="center">第三个选项</td>
				<td><input type="text" size="64" class="input" name="three"></td>
			</tr>
			<tr class="tr">
				<td align="center">第四个选项</td>
				<td><input type="text" size="64" class="input" name="four"></td>
			</tr>
			<tr class="tr">
