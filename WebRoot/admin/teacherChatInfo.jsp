   ...
   <table width="100%" align="center" bgcolor="#3CB371" height="50px">
        ...
        <table width="76%" align="center">
            <tr>
                ...
                <td width="60%" align="center"><span class="span"><a href="admin/addChatInfo.jsp" class="href">
		...
		<table width="90%" align="center">
			...
			<tr align="center" bgcolor="#D1EEEE" height="32">
				...
				<td>
				    <a href="admin/chatDetailInfos.jsp?pcode=<%=list.get(i).getCode()%>"
				...
				<td>
					<a href="admin/addChatss.jsp?pcode=<%=list.get(i).getCode()%>&pname=<%=list.get(i).getName()%>"
