...
<div id = "allDiv">	
   <form method="post" action="TeacherLoginServlet" autocomplete="off" id = "form">
      <div id ="div">
		<table width="100%" height="100%">
			...
			<tr height="10%" class="tr3">
				<td><center>
						<pre>在  线  学  习  平  台  教  师  登  录  界  面</pre>
					</center></td>
			</tr>
	   ...
	   <img src="picture/teacher.png" alt="图片">
   </form>
   </div>
</body>
</html>
