...
<div style="height: 55px">
   ...
   <table width="100%" align="center" bgcolor="#3CB371" height="50px">
        <tr>
            ...
            <td width="5%"></td>
            <td align="left"><span class="span">课程讨论详情页面</span></td>
            <td width="10%"></td>
        ...
        <table width="76%" align="center">
            <tr>
                <td align="left" ><span class="span"><a href="admin/teacherChatInfo.jsp" class="href">
		...
		<%
			...
			ArrayList<Chat> list = cdbh.queryByCode(code);
		%>
		...
		<table width="90%" align="center">
			...
			<tr align="center" bgcolor="#D1EEEE" height="32">
				...
				<td>
				     <span><%=list.get(i).getUsername()%></span>
				</td>
				<td>
					 <span><%=list.get(i).getAdvice()%></span>
				</td>
				<td>
