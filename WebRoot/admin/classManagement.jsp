   ...
   <table width="100%" align="center" bgcolor="#3CB371" height="50px">
        ...
        <table width="76%" align="center">
            <tr>
                ...
                <td width="60%" align="center"><span class="span"><a href="admin/addProjects.jsp" class="href">
		...
		<%
			...
			ArrayList<Project> list = pdbh.queryByUsercode(usercode);
		%>
		...
		<table width="90%" align="center">
			...
			<tr align="center" bgcolor="#D1EEEE" height="32">
			    ...
			    <td>
					<a href="admin/addFiles.jsp?pname=<%=list.get(i).getName()%>&pcode=<%=list.get(i).getCode()%>" class="a">课件上传</a>
				</td>
				<td>
					<a href="admin/studentUpdateProject.jsp?id=<%=list.get(i).getId()%>" class="a">update</a>
				</td>
				<td>
				    <a href="admin/teacherDeleteProject.jsp?id=<%=list.get(i).getId()%>" class="a" onclick="return confirmDeleteJsp()">delete</a>
			    </td>
			</tr>
