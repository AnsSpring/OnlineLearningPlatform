...
<div style="height: 55px">
   ...
   <table width="100%" align="center" bgcolor="#3CB371" height="50px">
        <tr>
            ...
            <td width="5%"></td>
            <td align="left"><span class="span">学生作业下载</span></td>
        ...
        <table width="76%" align="center">
            <tr>
                ...
                <td width="60%" align="center"><span class="span"><a href="admin/addFile.jsp" class="href">
                <pre></pre></a></span></td>
		...
		<%
			...
			ArrayList<FileVo> list = db.queryByType("2");
		%>
		...
		<table width="90%" align="center">
			...
			<tr align="center" bgcolor="#D1EEEE" height="32">
				...
				<td>
				    <a href="admin/uploadFile.jsp?fileName=<%=list.get(i).getName()%>"
						class="a">我要下载</a>
				</td>
