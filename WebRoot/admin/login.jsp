...
<div id = "allDiv">	
   <form method="post" action="LoginServlet" autocomplete="off" id = "form">
      <div id ="div">
		<table width="100%" height="100%">
			...
			<tr height="10%" class="tr3">
				<td><center>
						<pre>在  线  学  习  平  台  管  理  员  登  录  界  面</pre>
					</center></td>
			</tr>
	   ...
	   <img src="picture/informationManagement.png" alt="图片">
   </form>
