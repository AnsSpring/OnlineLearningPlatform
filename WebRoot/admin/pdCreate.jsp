...
<div style="height: 55px">
   ...
   <table width="100%" align="center" bgcolor="#3CB371" height="50px">
        <tr>
            ...
            <td width="5%"></td>
            <td align="left"><span class="span">作业创建 -- 创建判断题</span></td>
            <td width="10%"></td>
        ...
        <table width="76%" align="center">
            <tr>
                ...
                <td width="60%" align="center"><span class="span"><a href="admin/addPd.jsp" class="href">
                <pre>添加判断题</pre></a></span></td>
		...
		<table width="90%" align="center">
			...
			<tr align="center" bgcolor="#D1EEEE" height="32">
				<td>
					<a href="admin/queryJudgeQuestion.jsp?id=<%=list.get(i).getId()%>"
				...
				<td>
					<a href="admin/queryJudgeQuestion.jsp?id=<%=list.get(i).getId()%>"
						class="a"><%=list.get(i).getContent()%></a>
				</td>
				<td>
					<a href="admin/updatePd.jsp?id=<%=list.get(i).getId()%>" class="a">update</a>
				</td>
				<td>
				    <a href="admin/deletePd.jsp?id=<%=list.get(i).getId()%>" class="a" onclick="return confirmDeleteJsp()">delete</a>
			    </td>
			</tr>
