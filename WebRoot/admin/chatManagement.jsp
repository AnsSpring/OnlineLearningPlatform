	...
	<body bottommargin="0" topmargin="30px" leftmargin="0" rightmargin="0">
        ...
        <table width="76%" align="center">
            <tr>
                ...
                <td width="60%" align="center"><span class="span"><a href="admin/addChat.jsp" class="href">
                <pre>添加课程讨论</pre></a></span></td>
		...
		<table width="80%" align="center">
			...
			<tr align="center" bgcolor="#D1EEEE" height="32">
				<td>
					<a href="admin/queryChat.jsp?id=<%=list.get(i).getId()%>"
				...
				<td>
				    <a href="admin/updateChatIsCheck.jsp?id=<%=list.get(i).getId()%>" class="a">审核</a>
			    </td>
				<td>
					<a href="admin/updateChat.jsp?id=<%=list.get(i).getId()%>" class="a">update</a>
				</td>
				<td>
				    <a href="admin/deleteChat.jsp?id=<%=list.get(i).getId()%>" class="a" onclick="return confirmDeleteJsp()">delete</a>
			    </td>
			</tr>
