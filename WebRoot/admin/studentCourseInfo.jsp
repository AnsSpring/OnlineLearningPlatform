...
<div style="height: 55px">
   ...
   <table width="100%" align="center" bgcolor="#3CB371" height="50px">
        <tr>
            ...
            <td width="5%"></td>
            <td align="left"><span class="span">学生选课审核</span></td>
            <td width="10%"></td>
		...
		<%
			CourseDBHelp cdbh = new CourseDBHelp();
			ArrayList<SumCourse> list = cdbh.queryByTeacherCode(usercode);
		%>
		...
		<table width="90%" align="center">
			...
			<tr align="center" bgcolor="#D1EEEE" height="32">
			    ...
			    <td>
				    <a href="admin/updateCourses.jsp?id=<%=list.get(i).getId()%>" class="a">审核</a>
			    </td>
