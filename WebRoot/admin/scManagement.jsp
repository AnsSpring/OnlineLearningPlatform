	...
	<body bottommargin="0" topmargin="30px" leftmargin="0" rightmargin="0">
		...
		<table width="80%" align="center">
			...
			<tr align="center" bgcolor="#D1EEEE" height="32">
				...
				<td>
					<a href="admin/updateSingleChoice.jsp?id=<%=list.get(i).getId()%>" class="a">update</a>
				</td>
				<td>
				    <a href="admin/deleteSingleChoice.jsp?id=<%=list.get(i).getId()%>" class="a" onclick="return confirmDeleteJsp()">delete</a>
			    </td>
			</tr>
