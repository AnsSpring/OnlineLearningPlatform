...
<div style="height: 55px">
   ...
   <table width="100%" align="center" bgcolor="#3CB371" height="50px">
        <tr>
            ...
            <td width="5%"></td>
            <td align="left"><span class="span">课程信息管理-判断题-<span><%=pname%></span></span></td>
            <td width="6%"></td>
		...
		<%
	          ...
	          ArrayList<JudgeQuestion> list = jqdbh.queryByCode(pcode);
			
		%>

<form action="SumPdServlet" method="post" id ="form" >
		...
		<table width="96%" align="center">
			...
			<tr align="center" bgcolor="#D1EEEE" height="32">
				...
				<td>
					<span><%=list.get(i).getContent()%></span>
				</td>
