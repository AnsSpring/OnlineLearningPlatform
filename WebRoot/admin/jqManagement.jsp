	...
	<body bottommargin="0" topmargin="30px" leftmargin="0" rightmargin="0">
        ...
        <table width="76%" align="center">
            <tr>
                ...
                <td width="60%" align="center"><span class="span"><a href="admin/addJudgeQuestion.jsp" class="href">
		...
		<table width="80%" align="center">
			...
			<tr align="center" bgcolor="#D1EEEE" height="32">
				...
				<td>
					<a href="admin/updateJudgeQuestion.jsp?id=<%=list.get(i).getId()%>" class="a">update</a>
				</td>
				<td>
				    <a href="admin/deleteJudgeQuestion.jsp?id=<%=list.get(i).getId()%>" class="a" onclick="return confirmDeleteJsp()">delete</a>
			    </td>
			</tr>
