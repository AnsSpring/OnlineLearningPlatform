...
<div style="height: 55px">
   ...
   <table width="100%" align="center" bgcolor="#3CB371" height="50px">
        <tr>
            ...
            <td width="5%"></td>
            <td align="left"><span class="span">学生信息管理</span></td>
            <td width="10%"></td>
		...
		<%
			...
			ArrayList<Admin> list = adbh.queryStudent();
		%>
		...
		<table width="90%" align="center">
			...
			<tr align="center" bgcolor="#D1EEEE" height="32">
				...
				<td>
					<a href="admin/queryAdmins.jsp?id=<%=list.get(i).getId()%>"
						class="a"><%=list.get(i).getUsercode()%></a>
				</td>
				<td>
				    <a href="admin/queryAdmins.jsp?id=<%=list.get(i).getId()%>"
				...
				<td>
					<a href="admin/queryAdmins.jsp?id=<%=list.get(i).getId()%>" 
					    class="a"><%=list.get(i).getClassAndGrade()%></a>
				</td>
				<td>
				    <a href="admin/deleteStudent.jsp?id=<%=list.get(i).getId()%>" class="a" onclick="return confirmDeleteJsp()">delete</a>
			    </td>
			</tr>
